...
/// 暂存AGV任务表
/// </summary>
[SugarTable("EG_AGV_TaskStaging")]
public class TaskStagingEntity : EntityBase
{
    /// <summary>
    /// 任务编号
    /// </summary>
    ...
    /// 暂存状态（0 - 未下发，1 - 已下发）
    /// </summary>
    [SugarColumn(ColumnDescription = "暂存状态（0 - 未下发，1 - 已下发）")]
    public int StagingStatus { get; set; } = 0;
}
